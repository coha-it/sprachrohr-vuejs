<template lang="pug">
.ui.basic.segment
  h3.ui.header Application Demo-Content
  p
  ...
  .button.demo
    ...
    .ui.hidden.divider
    .ui.animated.button
      .visible.content Horizontal
      .hidden.content
        | Hidden
    .ui.vertical.animated.button
      .visible.content Vertical
      .hidden.content
        | Hidden
    .ui.animated.fade.button
      .visible.content Fade In
      .hidden.content
        | Hidden
    .ui.hidden.divider
    .ui.facebook.button
    ...
    .ui.inverted.segment
      .ui.inverted.button Inverted
      .ui.inverted.blue.button Blue
      .ui.inverted.red.button Red
      .ui.inverted.basic.button Basic
      .ui.inverted.blue.basic.button Blue
      .ui.inverted.red.basic.button Red
    .ui.hidden.divider
    .ui.vertical.buttons
      .ui.button Feed
      .ui.button Messages
